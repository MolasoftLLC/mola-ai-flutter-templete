...
class _$SakeMenuRecognitionApiClient extends SakeMenuRecognitionApiClient {
  ...
  @override
  Future<Response<Map<String, dynamic>>> resolveMenuSakes(
      Map<String, dynamic> body) {
    final Uri $url = Uri.parse('/api/menu-recognition/resolve');
    final $body = body;
    final Request $request = Request(
      'POST',
      $url,
  ...
  Future<Response<Map<String, dynamic>>> reportSakeCommunityReview(
    ...
    final Uri $url =
        Uri.parse('/api/sakes/community/reviews/${reviewId}/report');
    final $body = body;
    final Request $request = Request(
      'POST',
      $url,
